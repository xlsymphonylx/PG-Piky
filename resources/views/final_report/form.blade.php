    ...
    <div class="form-custom__container">
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->fwd_port_initial !== null ? number_format($draft->fwd_port_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->fwd_port_final !== null ? number_format($draft->fwd_port_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->fwd_starboard_initial !== null ? number_format($draft->fwd_starboard_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->fwd_starboard_final !== null ? number_format($draft->fwd_starboard_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->mean_foward_initial !== null ? number_format($draft->mean_foward_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->mean_foward_final !== null ? number_format($draft->mean_foward_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->correction_to_fp_initial !== null ? number_format($draft->correction_to_fp_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->correction_to_fp_final !== null ? number_format($draft->correction_to_fp_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->corrected_fwd_initial !== null ? number_format($draft->corrected_fwd_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->corrected_fwd_final !== null ? number_format($draft->corrected_fwd_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->midship_port_initial !== null ? number_format($draft->midship_port_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->midship_port_final !== null ? number_format($draft->midship_port_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->midship_starboard_initial !== null ? number_format($draft->midship_starboard_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->midship_starboard_final !== null ? number_format($draft->midship_starboard_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->mean_midship_initial !== null ? number_format($draft->mean_midship_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->mean_midship_final !== null ? number_format($draft->mean_midship_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->correction_to_midship_initial !== null ? number_format($draft->correction_to_midship_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->correction_to_midship_final !== null ? number_format($draft->correction_to_midship_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->corrected_midship_initial !== null ? number_format($draft->corrected_midship_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->corrected_midship_final !== null ? number_format($draft->corrected_midship_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->aft_port_initial !== null ? number_format($draft->aft_port_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->aft_port_final !== null ? number_format($draft->aft_port_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->aft_starboard_initial !== null ? number_format($draft->aft_starboard_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->aft_starboard_final !== null ? number_format($draft->aft_starboard_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->mean_aft_initial !== null ? number_format($draft->mean_aft_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->mean_aft_final !== null ? number_format($draft->mean_aft_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->correction_to_aft_initial !== null ? number_format($draft->correction_to_aft_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->correction_to_aft_final !== null ? number_format($draft->correction_to_aft_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->corrected_aft_initial !== null ? number_format($draft->corrected_aft_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->corrected_aft_final !== null ? number_format($draft->corrected_aft_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->mean_fwd_aft_initial !== null ? number_format($draft->mean_fwd_aft_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->mean_fwd_aft_final !== null ? number_format($draft->mean_fwd_aft_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="displacement_for_mm_initial">Displacement for MM
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->displacement_for_mm_initial !== null ? number_format($draft->displacement_for_mm_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->displacement_for_mm_final !== null ? number_format($draft->displacement_for_mm_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="first_trim_correction_initial">1st Trim correction
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->first_trim_correction_initial !== null ? number_format($draft->first_trim_correction_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->first_trim_correction_final !== null ? number_format($draft->first_trim_correction_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="second_trim_correction_initial">2nd Trim correction
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->second_trim_correction_initial !== null ? number_format($draft->second_trim_correction_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->second_trim_correction_final !== null ? number_format($draft->second_trim_correction_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="total_trim_correction_initial">Total Trim Corr-n
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->total_trim_correction_initial !== null ? number_format($draft->total_trim_correction_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->total_trim_correction_final !== null ? number_format($draft->total_trim_correction_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="corrected_displacement_initial">Corrected Disp-t
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->corrected_displacement_initial !== null ? number_format($draft->corrected_displacement_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->corrected_displacement_final !== null ? number_format($draft->corrected_displacement_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="density_initial">Density
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->density_initial !== null ? number_format($draft->density_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->density_final !== null ? number_format($draft->density_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="density_correction_initial">Density Correction
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->density_correction_initial !== null ? number_format($draft->density_correction_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->density_correction_final !== null ? number_format($draft->density_correction_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="final_corrected_displacement_initial">Final Corr-d Disp-t
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->final_corrected_displacement_initial !== null ? number_format($draft->final_corrected_displacement_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                <label class="form-custom__label" for="final_corrected_displacement_final">Final Corr-d Disp-t
                    Final</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->final_corrected_displacement_final !== null ? number_format($draft->final_corrected_displacement_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="deductions_total_initial">Deductions Total
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->deductions_total_initial !== null ? number_format($draft->deductions_total_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                <label class="form-custom__label" for="deductions_total_final">Deductions Total
                    Final</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->deductions_total_final !== null ? number_format($draft->deductions_total_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="fuel_oil_initial">Fuel Oil
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->fuel_oil_initial !== null ? number_format($draft->fuel_oil_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->fuel_oil_final !== null ? number_format($draft->fuel_oil_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="diesel_oil_initial">Diesel Oil
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->diesel_oil_initial !== null ? number_format($draft->diesel_oil_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->diesel_oil_final !== null ? number_format($draft->diesel_oil_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="ballast_water_initial">Ballast Water
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->ballast_water_initial !== null ? number_format($draft->ballast_water_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->ballast_water_final !== null ? number_format($draft->ballast_water_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="fresh_water_initial">Fresh Water
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->fresh_water_initial !== null ? number_format($draft->fresh_water_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->fresh_water_final !== null ? number_format($draft->fresh_water_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="lubricating_oil_initial">Lubricating Oil
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->lubricating_oil_initial !== null ? number_format($draft->lubricating_oil_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->lubricating_oil_final !== null ? number_format($draft->lubricating_oil_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="sludge_initial">Sludge
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->sludge_initial !== null ? number_format($draft->sludge_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->sludge_final !== null ? number_format($draft->sludge_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="others_initial">Others
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->others_initial !== null ? number_format($draft->others_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->others_final !== null ? number_format($draft->others_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->net_displacement_initial !== null ? number_format($draft->net_displacement_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->net_displacement_final !== null ? number_format($draft->net_displacement_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->loaded_cargo !== null ? number_format($draft->loaded_cargo, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->discharged_cargo !== null ? number_format($draft->discharged_cargo, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="lbp_initial">LBP
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->lbp_initial !== null ? number_format($draft->lbp_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->lbp_final !== null ? number_format($draft->lbp_final, 2) : '' }}" id="lbp_final"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="fwd_dist_initial">FWD Dist
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->fwd_dist_initial !== null ? number_format($draft->fwd_dist_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->fwd_dist_final !== null ? number_format($draft->fwd_dist_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="mid_dist_initial">MID Dist
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->mid_dist_initial !== null ? number_format($draft->mid_dist_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->mid_dist_final !== null ? number_format($draft->mid_dist_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="aft_dist_initial">AFT Dist
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->aft_dist_initial !== null ? number_format($draft->aft_dist_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->aft_dist_final !== null ? number_format($draft->aft_dist_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="lbm_initial">LBM
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->lbm_initial !== null ? number_format($draft->lbm_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->lbm_final !== null ? number_format($draft->lbm_final, 2) : '' }}" id="lbm_final"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="trim_obs_initial">Trim OBS
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->trim_obs_initial !== null ? number_format($draft->trim_obs_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->trim_obs_final !== null ? number_format($draft->trim_obs_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="trim_corr_initial">Trim Corr
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->trim_corr_initial !== null ? number_format($draft->trim_corr_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->trim_corr_final !== null ? number_format($draft->trim_corr_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="tpc_initial">TPC
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->tpc_initial !== null ? number_format($draft->tpc_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->tpc_final !== null ? number_format($draft->tpc_final, 2) : '' }}" id="tpc_final"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="lcf_initial">LCF
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->lcf_initial !== null ? number_format($draft->lcf_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->lcf_final !== null ? number_format($draft->lcf_final, 2) : '' }}" id="lcf_final"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="mct_1_initial">MCT 1
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->mct_1_initial !== null ? number_format($draft->mct_1_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->mct_1_final !== null ? number_format($draft->mct_1_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="mct_2_initial">MCT 2
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->mct_2_initial !== null ? number_format($draft->mct_2_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->mct_2_final !== null ? number_format($draft->mct_2_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="difference_initial">Difference
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->difference_initial !== null ? number_format($draft->difference_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->difference_final !== null ? number_format($draft->difference_final, 2) : '' }}"
        ...
        <div class="form-custom__section">
            <div class="form-custom__group">
                <label class="form-custom__label" for="sag_plus_hog_initial">Sag+Hog
                    Initial</label>
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->sag_plus_hog_initial !== null ? number_format($draft->sag_plus_hog_initial, 2) : '' }}"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->sag_plus_hog_final !== null ? number_format($draft->sag_plus_hog_final, 2) : '' }}"
        ...
        <div class="form-custom_section">
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->constant !== null ? number_format($draft->constant, 2) : '' }}" id="constant"
            ...
            <div class="form-custom__group">
                ...
                <input readonly type="text" class="form-custom__input"
                    value="{{ $draft->light_ship !== null ? number_format($draft->light_ship, 2) : '' }}" id="light_ship"
