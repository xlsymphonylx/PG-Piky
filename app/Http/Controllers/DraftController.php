...
class DraftController extends Controller
{
    ...
    public function finalize()
    {
        ...
        $draft->corrected_midship_initial = ($draft->mean_aft_initial + $draft->correction_to_midship_initial);
        $draft->corrected_midship_final = ($draft->mean_aft_final + $draft->correction_to_midship_final);
        ...
        $draft->trim_corr_initial = ($draft->corrected_fwd_initial - $draft->corrected_aft_initial);
        $draft->trim_corr_final = ($draft->corrected_fwd_final - $draft->corrected_aft_final);
        ...
        $draft->sag_plus_hog_initial = $draft->corrected_midship_initial - ($draft->mct_1_initial + $draft->mct_2_initial) / 2;
        $draft->sag_plus_hog_final = $draft->corrected_midship_final - ($draft->mct_1_final + $draft->mct_2_final) / 2;
        ...
        $draft->constant = $draft->net_displacement_initial - $draft->constant;
